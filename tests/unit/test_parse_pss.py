"""Unit tests for PSS parser (Phase 2.1)."""
import sys
...
def test_blocking_from_pragma(roundtrip):
    """blocking attribute recovered from // ml-hpi: pragma comment."""
    _, recovered = roundtrip
    rec_reg = next(i for i in recovered.spec.interfaces if i.short_name() == "RegIf")
